...
// prepend(), before(), and after().) Anything that looks like an array (i.e. has a length property and indexed attributes) will also work.
    ...
    $.fn[method_name] = function () {
      for (var i = 0, l = arguments.length, x, xs; x = arguments[i], i < l; ++i)
        if (x !== null && x !== undefined)
          if (x.length && x.constructor !== String && (xs = Array.prototype.slice.call(x)).length === x.length)
